...
<div class="flip-card-container" style="--hue: 350">
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        <li>Hall Type :<c:out value="${user.roomtype}" /></li>
        <li>Per Day cost: <c:out value="${user.cost}" /> Rs</li>
        <li> Hall Facilities : <c:out value="${user.facilities}" /></li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserhallBook'" >Book</button>
