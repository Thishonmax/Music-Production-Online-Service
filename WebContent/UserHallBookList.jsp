...
<button onclick="window.location.href='<%=request.getContextPath()%>/listcardhall'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>

<h1>
	<span class="blue">My Halls <span class="blue"> <span
...
<table class="container">
	<thead>
		<tr>
			...
			<th><h1>NO OF Rooms</h1></th>
			<th><h1>Total Members</h1></th>
