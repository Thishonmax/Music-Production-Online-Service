...
<button onclick="window.location.href='<%=request.getContextPath()%>/newuserbanq'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>
