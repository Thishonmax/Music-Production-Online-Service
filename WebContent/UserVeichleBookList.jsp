...
<button onclick="window.location.href='<%=request.getContextPath()%>/listtransportcards'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>
<h1>
	<span class="blue">My Veichle<span class="blue"> <span
