  ...
  <div class="flip-card">
    ...
    <div class="card-front">
      <figure>
        ...
        <figcaption><c:out value="${user.name}" /></figcaption>
      </figure>

      <ul>
        <li>Facilities : <c:out value="${user.facilities}" /></li>
        <li>Per Day cost: <c:out value="${user.cost}" /> Rs</li>
        <li> Veichle Type : <c:out value="${user.type}"/></li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserveichleBook'" >Book</button>
