...
<div style="width: 100%;
    ...
    padding: 8px;
        text-align: right;
    ">
<button onclick="window.location.href='MemberView.jsp'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Back to Home
</button>
<button onclick="window.location.href='<%=request.getContextPath()%>/newuserres'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>
<h1>
	<span class="blue">Restaurant<span class="blue"> <span
